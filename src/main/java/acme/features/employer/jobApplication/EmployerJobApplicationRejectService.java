...
@Service
public class EmployerJobApplicationRejectService implements AbstractUpdateService<Employer, JobApplication> {
	...
	public void validate(final Request<JobApplication> request, final JobApplication entity, final Errors errors) {
		...
		if (!errors.hasErrors("justification")) {
			...
			errors.state(request, !vacio, "justification", "employer.jobApplication.error.justification");
		}
