...
<acme:form>
	...
	<acme:form-textarea code="administrator.investorrecord.form.label.sector" 
	path="sector"/>
	
	<acme:form-url code="administrator.investorrecord.form.label.statement" path="statement"/>
	<acme:form-textarea code="administrator.investorrecord.form.label.stars" path="stars"/>
